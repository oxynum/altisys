(function () {
    ...
    app.controller('litigeFromPromesseController', ['$rootScope', '$scope', '$http', '$stateParams', 'modalState', '$filter', 'config', function ($rootScope, $scope, $http, $stateParams, modalState, $filter, config) {
        ...
        $scope.AddLitige = function () {
           ...
           $http({
                method: 'POST',
                url: config.url + '/Litige/AddLitigeFromPromesse',
