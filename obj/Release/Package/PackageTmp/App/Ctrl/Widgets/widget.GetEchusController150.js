(function (app) {
    'use strict';
    app.controller('widgetGetEchusController150', ['$scope', '$http', '$location', 'gridConfService', 'config', 'cookieService', function ($scope, $http, $location, gridConfService, config, cookieService) {
        ...
        gridConfService.simpleConf$columnDefs$specificDefs($scope, config.url + '/Widget/GetEchuSup/150/##paging-params##/?userFilter=' + userFilter, null, defs);
