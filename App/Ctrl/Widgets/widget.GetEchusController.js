(function (app) {
    'use strict';
    app.controller('widgetGetEchusController', ['$scope', '$http', '$location', 'gridConfService', 'config', 'cookieService', function ($scope, $http, $location, gridConfService, config, cookieService) {
        ...
        gridConfService.simpleConf$columnDefs$specificDefs($scope, config.url + '/Widget/GetEchu/##paging-params##/?userFilter=' + userFilter, null, defs);
