(function (app) {
    'use strict';
    app.controller('widgetGetEchusController90', ['$scope', '$http', '$location', 'gridConfService', 'config', 'cookieService', function ($scope, $http, $location, gridConfService, config, cookieService) {
        ...
        gridConfService.simpleConf$columnDefs$specificDefs($scope, config.url + '/Widget/GetEchuSup/90/##paging-params##/?userFilter=' + userFilter, null, defs);
