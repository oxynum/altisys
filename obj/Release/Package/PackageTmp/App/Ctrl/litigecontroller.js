(function () {
    ...
    app.controller('litigecontroller', ['$rootScope', '$scope', '$http', '$stateParams', 'modalState', 'config', '$location', function ($rootScope, $scope, $http, $stateParams, modalState, config,$location) {
        ...
        $http({
         ...
         .success(function (data) {
             ...
             $scope.LitigeCreate.DMR = data.DMR;
             ...
             $scope.LitigeCreate.DMR = new Date();
             $scope.Courrier = {};
        ...
        $scope.DisputeCodeSelectedChanged = function() {
            $http({
             ...
             .success(function (data) {
                    ...
                    $scope.LitigeCreate.DMR = dateRelance.setDate(dateRelance.getDate() + nbJour);
