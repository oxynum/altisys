(function () {
    ...
    app.controller('viewerController', ['$rootScope', '$scope', 'config', function ($rootScope, $scope, config) {
        ...
        $scope.reports = {
            model : null,
            availableOptions: [
                { id: '0', name: 'SimpleList.js' },
                { id: '1', name: 'MultiColumnList.js' },
                { id: '2', name: 'HighlightCondition.js' },
                { id: '3', name: 'SiteStatistics.js' },
                { id: '4', name: 'SmartphoneBestsellersInQ12015.js' },
                { id: '5', name: 'UsersAppleIpad.js' },
                { id: '6', name: 'Images.js' },
                { id: '7', name: 'MasterDetail.js' },
                { id: '8', name: 'OnlineStoreSales.js' },
                { id: '9', name: 'ParametersSelectingCountry.js' },
                { id: '10', name: 'SideBySideListWithContainers.js' }
                //{ id: '11', name: 'SimpleList.mrt' },
                //{ id: '12', name: 'InvoiceReport.js' },
                //{ id: '13', name: 'ReportFactures.js' },
                //{ id: '14', name: 'ReportWizardCourrierStd.js' }
            ]
        };
...
//});
        ...
        $scope.loadReport = function (idReport) {
        ...
        var reportName = '';
        if (idReport != null) {
            reportName = $scope.reports.availableOptions[idReport].name;
        } else {
            reportName = 'OnlineStoreSales.js';
        }
        ...
        //report.loadFile('/reports/SmartphoneBestsellersInQ12015.js');
        //report.loadFile('/reports/UsersAppleIpad.js');
        //report.loadFile('/reports/Images.js');
        //report.loadFile('/reports/MasterDetail.js');
        //report.loadFile('/reports/OnlineStoreSales.js');
        //report.loadFile('/reports/ParametersSelectingCountry.js');
        //report.loadFile('/reports/SideBySideListWithContainers.js');
